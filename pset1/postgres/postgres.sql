CREATE USER matheussr SUPERUSER INHERIT CREATEDB CREATEROLE;

ALTER USER matheussr PASSWORD '123456';
...
CREATE SCHEMA elmasri AUTHORIZATION matheussr;

alter user matheussr;

set search_path to elmasri, matheussr, public;
...
insert into funcionario (primeiro_nome, nome_meio, ultimo_nome, cpf, data_nascimento, endereco, sexo, salario, cpf_supervisor, numero_departamento)
values ('Joice' , 'A', 'Leite', '45345345376', '07-31-1972', 'Av.Lucas Obes, 74, São Paulo, SP', 'F', 25.000, '33344555587', 5);
